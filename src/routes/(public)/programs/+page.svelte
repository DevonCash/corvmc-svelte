	...
	<div class="max-w-5xl mx-auto">
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
			...
			<div class="rounded-lg p-6 paper-tape" style="background: color-mix(in oklch, #2ea076 15%, var(--surface)); border: 1px solid color-mix(in oklch, #2ea076 20%, transparent); --tape-color: rgba(0, 133, 155, 0.7); --tape-x: 60%; --tape-rotate: 2deg">
				...
				<ul class="space-y-2 text-sm leading-relaxed pl-5 list-disc" style="color: var(--fg-1)">
	...
	<div class="max-w-5xl mx-auto">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
			<div class="rounded-lg p-6" style="background: color-mix(in oklch, var(--cmc-yellow) 25%, var(--surface)); border: 1px solid color-mix(in oklch, var(--cmc-yellow) 30%, transparent)">
				...
				<div class="text-sm space-y-1 mb-4" style="color: var(--fg-1)">
					<div><strong>When</strong> &middot; 1st Thursday of every month, 6:30 PM &ndash; 8:00 PM</div>
					<div><strong>Format</strong> &middot; Open jam session, all skill levels welcome</div>
				</div>
